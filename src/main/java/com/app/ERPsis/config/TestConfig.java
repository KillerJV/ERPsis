...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2019-11-09T12:30:07Z"), u1);
        Order o2 = new Order(null, Instant.parse("2018-10-09T07:55:08Z"), u2);
        Order o3 = new Order(null, Instant.parse("2019-07-09T10:18:22Z"), u1);
